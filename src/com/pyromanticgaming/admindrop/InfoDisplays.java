...
public class InfoDisplays {
	...
	public static void commadInfo(CommandSender sender) {
		...
		sender.sendMessage("/ad deathdrop [player] [ON/OFF] - Toggles other's Death Drops on/off");
		...
		sender.sendMessage("/ad throwaway [player] [ON/OFF] - Toggles other's throw away items on/off");
		...
		sender.sendMessage("/ad pickup [player] [ON/OFF] - Toggles other's ability to pick up items on/off");
		...
		sender.sendMessage("/ad chestaccess [player] [ON/OFF] - Toggles other's ability to open chests on/off");
		...
		sender.sendMessage("/ad blockbreak [player] [ON/OFF] - Toggles other's restriction to break blocks on/off");
		...
		sender.sendMessage("/ad blockplace [player] [ON/OFF] - Toggles other's restriction to place blocks on/off");
	...
	public static void altCommandInfo(CommandSender sender) {
		...
		sender.sendMessage("/ad dd [player] [ON/OFF] - Toggles other's Death Drops on/off");
		sender.sendMessage("/ad ta - Toggles throwing items");
		sender.sendMessage("/ad ta [player] - Toggles other's throw away items on/off");
		sender.sendMessage("/ad ta [player] [ON/OFF] - Toggles other's throw away items on/off");
		...
		sender.sendMessage("/ad pu [player] [ON/OFF] - Toggles other's ability to pick up items on/off");
		...
		sender.sendMessage("/ad ca [player] [ON/OFF] - Toggles other's ability to open chests on/off");
		...
		sender.sendMessage("/ad bb [player] [ON/OFF] - Toggles other's restriction to break blocks on/off");
		...
		sender.sendMessage("/ad bp [player] [ON/OFF] - Toggles other's restriction to place blocks on/off");
		sender.sendMessage("/ad status - Gets current status");
		sender.sendMessage("/ad help - Displays commands");
		sender.sendMessage("/ad status [player] - Gets players current status");
